describe('App', function() {
  ...
  it('queues the next song when an "enqueue" event is fired', function(){
    ...
    // this test fails because my implementation will automatically dequeue song and play it if no song is playing already
    // expect(app.get('songQueue').at(0)).to.equal(app.get('library').at(1));
    // expect(app.get('currentSong').to.equal(app.get('library').at(1)));
  });
